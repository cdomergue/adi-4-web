export function renderWGob3(main, episode = '3') {
  ...
  main.innerHTML = `<section class="wgob3-page"><a href="#games" class="back-link">← Les jeux</a>
    ...
    <p class="quiet">Clique pour sélectionner un personnage, te déplacer ou agir. ${episode === '1' ? 'Le tableau de bord se trouve en bas de l’écran.' : 'Survole le haut de l’écran pour ouvrir le tableau de bord.'} Échap permet de passer le générique.${episode === '1' ? ' Note les codes de niveau donnés par le jeu pour reprendre ton aventure.' : ' Utilise le menu du jeu pour sauvegarder.'}</p>
