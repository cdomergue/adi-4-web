export async function renderGames(main,info){
  ...
  try{
    ...
    const grid=document.createElement('div');grid.className='simulation-grid';root.append(grid);
    for(const game of games){
      ...
      const title=document.createElement('h2');title.textContent=game.title;button.append(title);
