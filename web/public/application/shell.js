export function createShell(isStorageAvailable) {
  ...
  $('#about-button').onclick = () =>
    info(
      ...
      <p><strong>Les documents :</strong> les animaux en danger, le cycle de l’eau, l’astronomie, les planètes et la conquête de l’espace, avec les décors, zones cliquables, films et voix d’origine.</p>
      ...
      <p><strong>Encore en reconstruction :</strong> les exercices, les autres jeux, les outils, l’Atlas et les six simulations d’environnement du menu Documents. Les petites animations d’ambiance des documents restent à compléter. Certains médias des simulations restent indisponibles et leur synchronisation audiovisuelle n’est pas garantie à l’identique. Certaines séquences, transitions et interactions restent à restituer, et les illustrations et médias des cours ne sont pas encore tous disponibles.</p>
