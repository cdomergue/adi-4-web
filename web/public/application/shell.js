export function createShell(isStorageAvailable) {
  ...
  $('#about-button').onclick = () =>
    info(
      ...
      <p><strong>Les jeux :</strong> la caisse donne accès à Sokoban et ses 15 niveaux, à Goblins 3 et à Mr. Matt I et ses 25 niveaux.</p>
      <p><strong>Les sciences :</strong> les décors de la station, 14 simulations avec leurs calculs, animations et voix, l’encyclopédie illustrée et ses films, les cours de la 6e à la 3e, le dictionnaire et le carnet personnel.</p>
      ...
      <p><strong>Encore en reconstruction :</strong> les exercices, les autres jeux, les outils et les documents de la chambre. Certaines séquences, transitions et interactions restent à restituer, et les illustrations et médias des cours ne sont pas encore tous disponibles.</p>
  ...
  $('#credits-button').onclick = () =>
    info(
      ...
      <p><strong>Moteur de Goblins 3 :</strong> ScummVM 2.9.0, compilé en WebAssembly. <a href="/vendor/wgob3/COPYING">Licence du moteur</a>.</p>`,
    );
