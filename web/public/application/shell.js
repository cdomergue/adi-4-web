export function createShell(isStorageAvailable) {
  ...
  $('#about-button').onclick = () =>
    info(
      ...
      <p><strong>Les jeux :</strong> la caisse donne accès à Sokoban et ses 15 niveaux, aux trois Goblins, à Mr. Matt I et II (25 et 35 niveaux), à BeeBop I et ses 45 tableaux en JavaScript natif, ainsi qu’aux quatre épisodes de Bad Toys 3D. BeeBop I utilise les règles décompilées, le menu, les images et les sons originaux, avec classement et séquences de fin ; la comparaison audiovisuelle complète avec une partie Windows reste non validée. La caisse se parcourt aussi avec la molette de la souris.</p>
      ...
      <p><strong>Encore en reconstruction :</strong> les exercices, les autres jeux, les outils. Les réglages de l’Atlas et des simulations d’environnement restent propres à la consultation ; l’Atlas mémorise la présentation automatique. Les panneaux des simulations associent les images originales à du texte net rendu par le navigateur. Les finitions de fidélité restent obligatoires : transitions intermédiaires, synchronisation et comparaison des interactions des documents. Certains médias des simulations restent indisponibles et leur synchronisation audiovisuelle n’est pas garantie à l’identique. Certaines séquences, transitions et interactions restent à restituer, et les illustrations et médias des cours ne sont pas encore tous disponibles.</p>
