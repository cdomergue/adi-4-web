export function createShell(isStorageAvailable) {
  ...
  $('#about-button').onclick = () =>
    info(
      ...
      <p><strong>Encore en reconstruction :</strong> les exercices, les autres jeux, les outils et les documents de la chambre. Certains médias des simulations restent indisponibles et leur synchronisation audiovisuelle n’est pas garantie à l’identique. Certaines séquences, transitions et interactions restent à restituer, et les illustrations et médias des cours ne sont pas encore tous disponibles.</p>
