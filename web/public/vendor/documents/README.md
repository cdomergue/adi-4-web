...
4.0.10 pour la simulation de développement d’un pays d’ADI 4.21 français.
...
du document interprété, ainsi que leurs ressources communes. Les
ressources binaires propres à `S07`, `S12`, `S14`, `S16` et `S17` en sont exclues : ces documents
...
sauvegarde persistante de la session de ce document.
