...
await cp(path.join(here, 'public'), path.join(here, 'dist'), { recursive: true, preserveTimestamps: true });
const html = await releaseAssets(path.join(here, 'public'), path.join(here, 'dist'),
